...
* [資料處理與清洗](https://yijutseng.github.io/DataScienceRBook/manipulation.html)
...
* [Regular Expession 101](https://regex101.com/)
* [常用的正規表示式](https://ihateregex.io/)
* [視覺化呈現正規表示式的規則路徑](https://jex.im/regulex/#!flags=&re=%5E(a%7Cb)*%3F%24)
* [YenLinWu'](https://github.com/YenLinWu/Coding_Notes/tree/main/Regular%20Expression)
